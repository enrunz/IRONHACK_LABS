    ...
    def guess(self,a,b,c,d):
        ...
        if self.count==3:
            ...
            if feedback==win:
                ...
                self.count=self.count+1
                return f'Oh no! BOX MALFUNCTION: The next pandemic has hit. Everyone will die and you are to blame!'
    ...
    def play (self):
        ...
        while self.count<4:
            try:
                ...
                print(self.guess(a,b,c,d))
                
            except ValueError as V:
                if('A' in str(V)):
                    print(f'You entered a number that does not correspond to a vaccine')
                else:
                    print(f'Remember to enter the information in code and separated by commas only')
