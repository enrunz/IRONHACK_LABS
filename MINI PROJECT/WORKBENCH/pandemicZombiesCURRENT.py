    ...
    def guess(self,a,b,c,d):
        ...
        if self.count==3:
            ...
            if feedback==win:
                ...
                self.count=self.count+1
                return f'Wrong code. BOX MALFUNCTION: The next pandemic has hit. Everyone will die and you are to blame!'
    ...
    def play (self):
        ...
        while self.count<4:
            try:
                ...
                print(f'You must enter the information in code separated by commas only')
